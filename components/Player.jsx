...
const Player = ({ songId, setSongId, isTrackPlaying, setIsTrackPlaying }) => {
  ...
  return (
    <div className="h-24 bg-neutral-800 border-t fixed bottom-0 left-0 w-full border-neutral-700 text-white grid grid-cols-3 text-xs md:text-base px-2 md:px-8">
